...
export const denyAll = () =>
  jwt({ secret: "" + Math.random(), algorithms: ["RS256"] });
  jwt({ secret: process.env.PUBLIC_KEY, algorithms: ["RS256"] });
  jsonwebtoken.sign(user, privateKey, { expiresIn: "6h", algorithm: "RS256" });
